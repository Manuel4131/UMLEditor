...
public class Cmp_Line_Mode extends Mouse_Mode
{
	...
	Composition_line A_New_Cmp_Line; 
	
	
	public Cmp_Line_Mode()
	{
		System.out.println("CompositionLineMode.");
	...
	public void mouseReleased(MouseEvent e) 
	{
		...
		else		//to create a new composition line 
		{
			A_New_Cmp_Line = new Composition_line( Link_Starts_From_P,Link_Ends_At_P );
			//�Х�[�^canvas
			canvas.Add_To_Line_Mang(A_New_Cmp_Line);
			
			//�A������ �ڤ����A
			A_New_Cmp_Line.Get_Start_Port().Add_Link_Lines(A_New_Cmp_Line);
			A_New_Cmp_Line.Get_End_Port().Add_Link_Lines(A_New_Cmp_Line);
			A_New_Cmp_Line.draw();
